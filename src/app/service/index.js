 ...
 * @LastEditTime: 2020-06-06 18:21:49
...
// 打开新页面
const createTab = (data) => sendMessage({ command: "createTab", data })

export { startCapture, slideFetch, destory, lastColor, create, activeTab, lastSevenDay, createTab };
